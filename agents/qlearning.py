...
class QLearningAgent(Agent):
    ...
    def __init__(
        self,
        env: BaseEnvironment,  # Use the interface type hint
    ...
    def learn(self, episode_history: List[Tuple[StateType, ActionType, float, bool]]):
        ...
        final_reward = episode_history[-1][
            2
        ]  # Reward from final step for the agent being trained
        ...
        agent_player_index = (
            0  # TODO: Make this more robust if agent can be other players
        )
